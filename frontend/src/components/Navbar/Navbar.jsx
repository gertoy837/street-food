...
const navigation = [
  { name: "Kategori", href: "/kategori", current: false },
  { name: "Makanan", href: "/makanan", current: false },
            ...
            <div className="relative flex h-16 items-center justify-between">
              ...
              <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                <div className="flex flex-shrink-0 items-center">
                  <NavLink to={'/'}>
                    <h1 className="fontH1 text-white border-b">STREET FOOD</h1>
                  </NavLink>
                </div>
              ...
              <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                ...
                <NavLink to={'/checkout'}
                  type="button"
                  className="relative p-3 text-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800"
                >
